...
export function getHeatIndexStyle(category: HeatIndex["category"]): HeatIndexStyle {
  switch (category) {
    ...
    case "PRECAUCIÓN EXTREMA":
      return {
        gradient: "from-orange-600/10 to-orange-500/25",
    ...
    case "PELIGRO":
      return {
        gradient: "from-red-600/10 to-red-500/25",
    ...
    case "PELIGRO EXTREMO":
      return {
        gradient: "from-purple-600/10 to-fuchsia-500/30",
    ...
    case "MÁS ALLÁ DEL UMBRAL HUMANO":
      return {
        gradient: "from-slate-900/10  to-slate-800/40",
